...
class Icons:
    ...
    export_testdata: str = 'fa-solid fa-file-export'
    ...
    import_testdata: str = 'fa-solid fa-upload'
    library: str = 'fa-solid fa-robot'
    library_import_args: str = 'fa-solid fa-list'
    library_unavailable: str = 'fa-solid fa-xmark'
    library_update: str = 'fa-solid fa-circle-arrow-up'
    library_up_to_date: str = 'fa-solid fa-check'
    lock: str = 'fa-solid fa-lock'
    ...
    split_cancel: str = 'fa-solid fa-xmark'
    split_ok: str = 'fa-solid fa-check'
    split_sequence: str = 'fa-solid fa-scissors'
    ...
    unlock: str = 'fa-solid fa-lock-open'
